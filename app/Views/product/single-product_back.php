		...
		<div class="container">
			<div class="row s_product_inner">
				<div class="col-lg-6">
					...
					<?php
				foreach(unserialize($images[0]['image_group']) as $img){?>
			
							<div class="single-prd-item">
								<img class="img-fluid" src="<?= URL .'img/product/'.$img?>" alt="">
							</div>
							<?php
									}
							?>
					...
					<?php	}?>
						<div class="col-lg-6">
							<div class="review_box">
								...
								<p>Outstanding</p>
								<form class="row contact_form" action="<?= URL. '/product/Product/review/'.$product->id ?>" method="post" id="contactForm" novalidate="novalidate">
									<div class="col-md-12">
										<div class="form-group">
