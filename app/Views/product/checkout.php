            ...
            <div class="billing_details">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form class="row contact_form" action="<?php echo URL. '/product/Checkout/checkout'?>" method="post" id="payment-form" novalidate="novalidate">
                            ...
                            <div class="col-md-12 form-group p_star">
                                ...
                                <span class="placeholder" value="<?php echo $userAddress->address_1 ?>" data-placeholder="Address line 01"></span>
                            </div>
                            <div class="col-md-12 form-group p_star">
                                <input type="text" class="form-control" id="add2" name="add2">
                                <span class="placeholder" value="<?php echo $userAddress->address_2 ?>" data-placeholder="Address line 02"></span>
                            </div>
                            <div class="col-md-12 form-group p_star">
