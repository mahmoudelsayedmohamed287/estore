...
<div id="undefined-sticky-wrapper" class="sticky-wrapper" style="height: 340px;"><header class="header_area sticky-header">
	...
	<!-- Start Header Area -->
		...
		<div class="search_input" id="search_input_box">
			<div class="container">
				<form id="searchForm" class="d-flex justify-content-between" method="POST" action="<?php echo URL. 'product/Catagory/serachByProduct'?>">
					<input id="searchvalue" type="text" name="searchProduct" class="form-control"  placeholder="Search Here">
					<button type="submit" class="btn" name="action"></button>
